...
describe('/polling create page', async () => {
    ...
    it('validates correct poll', () => {
        ...
        const urlMetadata = 'https://raw.githubusercontent.com/makerdao/community/master/governance/polls/Add%20the%20Aave%20Direct%20Deposit%20DAI%20Module%20-%20October%2011%2C%202021.md';
