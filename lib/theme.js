  ...
  icons: {
    ...
    govCalls: {
      path: (
        <g>
          <path
            d="M0 32H32V-2.38419e-07H20C8.95431 -2.38419e-07 0 8.95431 0 20V32Z"
          ...
          />
          <path d="M40 40H16V16H40V40Z" fill="url(#paint6_linear)" />
          <defs>
            <linearGradient
              id="paint4_linear"
              x1="32"
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#5FFB9E" />
              <stop offset="1" stopColor="#1AAB9B" />
            </linearGradient>
            <linearGradient
              id="paint5_linear"
              x1="2.30303"
