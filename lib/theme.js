...
export default {
  ...
  buttons: {
    ...
    outline: { ...theme.buttons.outline, borderColor: 'outline', borderRadius: 'round' },
    mutedOutline: {
      variant: 'buttons.outline',
      color: 'textSecondary',
  ...
  listboxes: {
    ...
    default: {
      ...
      list: { 'li[aria-selected="true"]': { backgroundColor: 'primaryMuted', width: '100%', color: 'text' } }
    }
  },
  menubuttons: {
  ...
  icons: {
    ...
    resourcesGovCycle: {
      ...
      path: (
        <g>
          <path
            d="M78.4297 78.229C58.8846 76.9426 43.4297 60.6816 43.4297 40.811C43.4297 20.9404 58.8846 4.67951 78.4297 3.39305V78.229Z"
            stroke="currentColor"
            strokeWidth="5"
          />
          <rect x="3.42969" y="3.31104" width="35" height="75" stroke="currentColor" strokeWidth="5" />
        </g>
      )
    }
  }
