...
export const useLandingPageDelegates = (): [
  ...
  const delegatesDataKey = `/api/delegates?network=${network}&delegateType=${DelegateTypeEnum.ALIGNED}&orderBy=${DelegateOrderByEnum.MKR}&orderDirection=${OrderDirectionEnum.DESC}&pageSize=0`;
