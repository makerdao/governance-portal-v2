...
query delegates($first: Int, $orderBy: String, $orderDirection: String, $filter: Delegate_filter) {
    delegates(first: $first, orderBy: $orderBy, orderDirection: $orderDirection, where: $filter) {
      blockTimestamp
      blockNumber
      ownerAddress
      totalDelegated
