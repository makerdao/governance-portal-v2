...
export const getDefaultProvider = (
  network: SupportedNetworks | string | undefined
    ...
    if (network === SupportedNetworks.TENDERLY) {
      return new ethers.providers.FallbackProvider([new ethers.providers.JsonRpcProvider(TENDERLY_RPC_URL || `https://virtual.mainnet.rpc.tenderly.co/${config.TENDERLY_RPC_KEY}`)], 1);
    } else {
