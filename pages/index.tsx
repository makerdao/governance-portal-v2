        ...
        <Flex sx={{ justifyContent: 'center' }}>
          ...
          >
            <Text sx={{ display: ['block', 'none'] }}>
              ...
              <Link href="//v1.vote.makerdao.com">v1.vote.makerdao.com</Link>.
            </Text>
            <Text sx={{ display: ['none', 'block'] }}>
              ...
              <Link href="//chat.makerdao.com/channel/governance-and-risk">Rocket Chat</Link>. The legacy
              Governance Portal can still be reached at{' '}
              <Link href="//v1.vote.makerdao.com">v1.vote.makerdao.com</Link>.
            </Text>
          </Badge>
        </Flex>
