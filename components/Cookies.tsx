    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Text as="p" sx={{ maxWidth: '500px', textAlign: 'center', margin: '0 auto', mb: 2 }}>
          This website uses cookies for analytic purposes only. Cookies are anonymous and do not link to user data. For por information, please read our <Link href="/cookies-policy" ><a title="Cookies policy"> Cookies policy</a></Link>
        </Text>
        ...
        <Flex sx={{
          ...
          <Box sx={{ mr: 2 }}>
            <Button title="Accept cookies" onClick={onClickAccept}>Accept configured cookies</Button>
          </Box>
          <Box sx={{ mr: 2 }}>
            <Button title="Reject all cookies" variant="outline" onClick={onClickReject}>Reject all cookies</Button>
          </Box>
        </Flex>
